...
if(isset($_POST['update_product'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?,category_id=?, price = ? WHERE id = ?");
...
<section class="update-product">
   ...
   <h1 class="heading">تحديث الوجبة</h1>
...
?>
   <form action="" enctype="multipart/form-data" method="post">
      ...
      <div class="flex-btn">
         <input type="submit" value="تحديث" class="btn" name="update_product">
         <a href="admin_products.php" class="option-btn">رجوع</a>
      </div>
   </form>
